...
<div class="sidebar">
   <nav class="nav flex-column p-3">
      ...
      <div class="collapse <?php if (in_array($current_page, $export_pages)) echo 'show'; ?>" id="exportSubmenu">
         <ul class="nav flex-column ps-3">
      ...
      <div class="collapse <?php if (in_array($current_page, $report_pages)) echo 'show'; ?>" id="reportSubmenu">
         <ul class="nav flex-column ps-3">
